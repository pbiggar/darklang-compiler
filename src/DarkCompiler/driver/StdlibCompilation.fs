...
let private loadStdlib () : Result<AST.ParsedProgram, string> =
    let stdlibFiles = [
        ...
        "stdlib/UInt128.dark"
        "stdlib/Bool.dark"
        "stdlib/CliFileSystem.dark"
        "stdlib/CliFileError.dark"
        "stdlib/Env.dark"
        "stdlib/Builtin.dark"
        "stdlib/Tuple2.dark"
        "stdlib/Tuple3.dark"
        ...
        "stdlib/CliTuiTextEscape.dark"
        "stdlib/CliTuiTextWidth.dark"
        "stdlib/CliTuiTextClip.dark"
        "stdlib/CliTuiText.dark"
        "stdlib/CliLog.dark"
