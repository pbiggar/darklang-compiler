...
let private listRefCountDecTuple3DynamicListDictListHelperLabel = "__dark_list_refcount_dec_tuple3_dynamic_list_dict_list_helper"
...
let private listRefCountDecClosureListDictListHelperLabel = "__dark_list_refcount_dec_closure_list_dict_list_helper"
...
let private listRefCountDecStringBytesListDictListHelperLabel = "__dark_list_refcount_dec_string_bytes_list_dict_list_helper"
let private listRefCountDecClosureStringListDictHelperLabel = "__dark_list_refcount_dec_closure_string_list_dict_helper"
let private listRefCountDecClosureStringListDictListHelperLabel = "__dark_list_refcount_dec_closure_string_list_dict_list_helper"
let private listRefCountDecClosureBytesListDictHelperLabel = "__dark_list_refcount_dec_closure_bytes_list_dict_helper"
let private listRefCountDecClosureBytesListDictListHelperLabel = "__dark_list_refcount_dec_closure_bytes_list_dict_list_helper"
...
let private listRefCountDecSumTuple4ClosureDynamicListDictListHelperLabel = "__dark_list_refcount_dec_sum_tuple4_closure_dynamic_list_dict_list_helper"
...
let private listRefCountDecHelperSpecs : ListRefCountDecHelperSpec list =
    ...
    { Label = listRefCountDecTuple3DynamicListDictListHelperLabel
      LeafGenericPayloadSize = (Some 24)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
      ManagedLeafFieldTypes = [ AST.TString; AST.TList AST.TInt64; AST.TDict (AST.TInt64, AST.TList AST.TInt64) ] }
    ...
    { Label = listRefCountDecClosureListDictListHelperLabel
      LeafGenericPayloadSize = (Some 24)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
      ManagedLeafFieldTypes = [ AST.TFunction ([ AST.TInt64 ], AST.TInt64); AST.TList AST.TInt64; AST.TDict (AST.TInt64, AST.TList AST.TInt64) ] }
    ...
    { Label = listRefCountDecStringBytesListDictListHelperLabel
      LeafGenericPayloadSize = (Some 32)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
      ManagedLeafFieldTypes = [ AST.TString; AST.TBytes; AST.TList AST.TInt64; AST.TDict (AST.TInt64, AST.TList AST.TInt64) ] }
    ...
    { Label = listRefCountDecClosureStringListDictListHelperLabel
      LeafGenericPayloadSize = (Some 32)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
      ManagedLeafFieldTypes = [ AST.TFunction ([ AST.TInt64 ], AST.TInt64); AST.TString; AST.TList AST.TInt64; AST.TDict (AST.TInt64, AST.TList AST.TInt64) ] }
    ...
    { Label = listRefCountDecClosureBytesListDictListHelperLabel
      LeafGenericPayloadSize = (Some 32)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
      ManagedLeafFieldTypes = [ AST.TFunction ([ AST.TInt64 ], AST.TInt64); AST.TBytes; AST.TList AST.TInt64; AST.TDict (AST.TInt64, AST.TList AST.TInt64) ] }
    ...
    { Label = listRefCountDecTuple4NestedTupleDynamicListDictListHelperLabel
      LeafGenericPayloadSize = (Some 32)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
    ...
    { Label = listRefCountDecSumClosureHelperLabel
      ...
      ReleaseLeafClosurePayload = false
      ManagedLeafFieldTypes = [ AST.TInt64; AST.TFunction ([AST.TInt64], AST.TInt64) ] }
    { Label = listRefCountDecSumTuple3DynamicListDictListHelperLabel
      LeafGenericPayloadSize = (Some 16)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
    ...
    { Label = listRefCountDecSumTuple4StringBytesListDictListHelperLabel
      LeafGenericPayloadSize = (Some 16)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
    ...
    { Label = listRefCountDecSumTuple4ClosureDynamicListDictListHelperLabel
      LeafGenericPayloadSize = (Some 16)
      ReleaseLeafListPayload = false
      ReleaseLeafDictPayload = false
      ReleaseLeafClosurePayload = false
...
let private releasePlanIsTuple3DynamicListDictListPayload (releasePlan: ANF.RcReleasePlan) : bool =
    releasePlan
    |> releasePlanIsFixedBlockWithFieldReleases
        24
        [
...
let private releasePlanIsTuple4ClosureDynamicListDictListPayload (releasePlan: ANF.RcReleasePlan) : bool =
    releasePlan
    |> releasePlanIsFixedBlockWithFieldReleases
        32
        [
...
let private listDecHelperForReleasePlan (releasePlan: ANF.RcReleasePlan) : string =
    let sumPayloadHelper (fieldReleases: ANF.RcFieldRelease list) : string =
        ...
        | Some payloadRelease when releasePlanIsTuple4ClosureDynamicListDictListPayload payloadRelease ->
...
let generateARM64WithOptions (options: CodeGenOptions) (program: LIR.Program) : Result<ARM64Symbolic.Instr list, string> =
    ...
    let unionPlannedListDecHelperMaps
        (maps: Map<string, int * ANF.RcReleasePlan> list)
        : Map<string, int * ANF.RcReleasePlan> =
        maps
    ...
    let plannedListDecHelpersInMetadata
