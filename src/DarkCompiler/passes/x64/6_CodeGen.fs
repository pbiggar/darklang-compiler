                        ...
                        | Some (AST.TList (AST.TSum (_, [AST.TRecord (name, _)]))) when
                            List.contains
                                ...
                                [listRefCountDecRecord1DynamicHelperLabel
                                 ...
                                 listRefCountDecRecord3DynamicAllHelperLabel] -> false
