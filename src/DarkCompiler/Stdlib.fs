...
let private integerBitwiseFunctions (typ: SemanticType) : ModuleFunc list =
...
let private integerBitwiseModule (name: string) (typ: SemanticType) : ModuleDef =
...
let resultType (okType: SemanticType) : SemanticType =
...
let fileIntrinsicModule : ModuleDef = {
    ...
    Functions = [
        ...
        { Name = "writeFromPtr"; TypeParams = []; ParamTypes = [TString; TInternalRawPtr; TInt64]; ReturnType = TUnit }
    ]
}
...
let rawMemoryIntrinsics : ModuleFunc list = [
    ...
    { Name = "__mapped_alloc"; TypeParams = []; ParamTypes = [TInt64]; ReturnType = TInternalRawPtr }
    { Name = "__mapped_free"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TUnit }
    // Fixed RC layout of the runtime list-array allocator's small branch.
    { Name = "__list_array_release_small"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TUnit }
    // __raw_alloc : (Int64) -> RawPtr - allocate raw bytes
    { Name = "__raw_alloc"; TypeParams = []; ParamTypes = [TInt64]; ReturnType = TInternalRawPtr }
    // __raw_free : (RawPtr) -> Unit - free an internal 8-byte raw cell
    { Name = "__raw_free"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TUnit }
    // __raw_get<v> : (RawPtr, Int64) -> v - read 8 bytes at offset, typed as v
    { Name = "__raw_get"; TypeParams = ["v"]; ParamTypes = [TInternalRawPtr; TInt64]; ReturnType = TVar "v" }
    // __raw_take<v> transfers a typed slot edge to the caller before it is cleared.
    { Name = "__raw_take"; TypeParams = ["v"]; ParamTypes = [TInternalRawPtr; TInt64]; ReturnType = TVar "v" }
    // __raw_write_word : (RawPtr, Int64, Int64) -> Unit - write 8 unmanaged bytes at offset
    { Name = "__raw_write_word"; TypeParams = []; ParamTypes = [TInternalRawPtr; TInt64; TInt64]; ReturnType = TUnit }
    // __raw_get_byte : (RawPtr, Int64) -> Int64 - read 1 byte at offset, zero-extended
    { Name = "__raw_get_byte"; TypeParams = []; ParamTypes = [TInternalRawPtr; TInt64]; ReturnType = TInt64 }
    // __raw_write_byte : (RawPtr, Int64, Int64) -> Unit - write 1 unmanaged byte at offset
    { Name = "__raw_write_byte"; TypeParams = []; ParamTypes = [TInternalRawPtr; TInt64; TInt64]; ReturnType = TUnit }
    // __raw_slot_init<v> : (RawPtr, Int64, v) -> Unit - initialize a typed slot edge
    { Name = "__raw_slot_init"; TypeParams = ["v"]; ParamTypes = [TInternalRawPtr; TInt64; TVar "v"]; ReturnType = TUnit }
    ...
    { Name = "__string_to_rawptr"; TypeParams = []; ParamTypes = [TString]; ReturnType = TInternalRawPtr }
    // __rawptr_to_string : (RawPtr) -> String - reinterpret initialized raw allocation as String
    { Name = "__rawptr_to_string"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TString }
    ...
    { Name = "__int_to_rawptr"; TypeParams = []; ParamTypes = [TInt]; ReturnType = TInternalRawPtr }
    { Name = "__rawptr_to_int"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TInt }
    ...
    { Name = "__int128_to_rawptr"; TypeParams = []; ParamTypes = [TInt128]; ReturnType = TInternalRawPtr }
    { Name = "__rawptr_to_int128"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TInt128 }
    { Name = "__uint128_to_rawptr"; TypeParams = []; ParamTypes = [TUInt128]; ReturnType = TInternalRawPtr }
    { Name = "__rawptr_to_uint128"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TUInt128 }
    ...
    { Name = "__blob_to_rawptr"; TypeParams = []; ParamTypes = [TBlob]; ReturnType = TInternalRawPtr }
    // __rawptr_to_blob : (RawPtr) -> Blob - reinterpret initialized raw allocation as Blob
    { Name = "__rawptr_to_blob"; TypeParams = []; ParamTypes = [TInternalRawPtr]; ReturnType = TBlob }
    // Stream handles are opaque source values with a raw-pointer runtime representation.
    { Name = "__stream_to_rawptr"; TypeParams = ["a"]; ParamTypes = [TStream(TVar "a")]; ReturnType = TInternalRawPtr }
    { Name = "__rawptr_to_stream"; TypeParams = ["a"]; ParamTypes = [TInternalRawPtr]; ReturnType = TStream(TVar "a") }
    ...
    { Name = "__dict_to_rawptr"; TypeParams = ["k"; "v"]; ParamTypes = [TDict(TVar "k", TVar "v")]; ReturnType = TInternalRawPtr }
    // __rawptr_to_dict<k, v> : (RawPtr, Int64) -> Dict<k, v> - create dict from pointer + tag
    { Name = "__rawptr_to_dict"; TypeParams = ["k"; "v"]; ParamTypes = [TInternalRawPtr; TInt64]; ReturnType = TDict(TVar "k", TVar "v") }
    ...
    { Name = "__list_to_rawptr"; TypeParams = ["a"]; ParamTypes = [TList(TVar "a")]; ReturnType = TInternalRawPtr }
    // __rawptr_to_list<a> : (RawPtr, Int64) -> List<a> - create list from pointer + tag
    { Name = "__rawptr_to_list"; TypeParams = ["a"]; ParamTypes = [TInternalRawPtr; TInt64]; ReturnType = TList(TVar "a") }
]
...
let getFunctionType (func: ModuleFunc) : SemanticType =
