...
**Snapshot timestamp:** 2026-08-15T08:45:41+00:00
**Architecture:** `arm64`
...
**Compiler commit:** `3a755ce9e001330e30aaf4905fbd7a69ee0f82c0` - Bound test-build memory usage

| Benchmark     |           Dark (2.25x) |          Rust |
|---------------|------------------------|---------------|
| ackermann     | 10,019,036,010 (2.15x) | 4,651,994,510 |
| binary_trees  |    649,092,188 (0.35x) | 1,842,791,955 |
...
| nbody         |  1,193,502,272 (4.82x) |   247,760,534 |
...
| spectral_norm |     74,939,657 (14.1x) |     5,297,561 |
