...
**Last Updated:** 2026-08-09 21:17:12
**Commit:** `61ecbf69` - Audit full and quick Rust benchmark parity

| Benchmark     |           Dark (3.10x) |          Rust |
|---------------|------------------------|---------------|
| ackermann     | 11,450,298,027 (2.46x) | 4,651,994,510 |
| collatz       |     81,541,905 (0.83x) |    98,242,178 |
| edigits       |   6,668,792,882 (489x) |    13,637,551 |
| factorial     |         60,603 (0.24x) |       257,669 |
| fasta         |    749,967,232 (37.0x) |    20,252,213 |
| fib           |    642,005,209 (2.49x) |   257,598,132 |
| leibniz       |    900,000,145 (1.12x) |   800,257,637 |
| mandelbrot    |     20,790,992 (1.53x) |    13,595,721 |
| matmul        |   2,126,300,694 (133x) |    15,983,852 |
...
| quicksort     |    378,612,348 (57.6x) |     6,574,976 |
| spectral_norm |    144,271,776 (27.2x) |     5,297,561 |
