...
retention, plus returned branch-selected borrowed bytes and dict projection
retention:

- `scripts/run-in-container ./run-tests`: `4667 passed, 2 failed`
...
Branch-selected borrowed returns are now covered for strings, bytes, and dicts.
...
- branch-selected borrowed values beyond the covered string, bytes, and dict
  projection cases
