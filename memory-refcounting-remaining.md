...
record-string-list-dict/sum capture release, including a
...
- `scripts/run-in-container ./run-tests`: `4645 passed, 2 failed`
...
- closure capture recursive release coverage beyond the current direct
  ...
  record-string-list-dict, and fixed-block capture probes
