...
- `scripts/run-in-container ./run-tests`: `4606 passed, 2 failed`
...
- list payload helper variants beyond tuple2 dynamic-buffer/list/closure/dict/string
