...
nested tuple string/list/dict payload release.
...
- list payload helper variants beyond the currently covered tuple2, exhaustive
  ...
  tuple4 nested tuple dynamic string and string/list/dict shapes, record1,
  exhaustive record3 dynamic-buffer combinations, mixed record3
  string/bytes/list/dict and closure/list/dict shapes, mixed record4
  string/bytes/list/dict and
