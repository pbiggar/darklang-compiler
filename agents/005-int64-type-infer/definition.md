...
2. Exclude legitimate `TInt64` uses, such as explicit integer literal representation, runtime tags, ABI-width behavior, tests whose purpose is already explicit Int64 behavior, and any site that is not plausibly an invalid default.
