...
1. Run the relevant roundtrip corpus command.
...
Report the first failing case, regression test, parser or pretty-printer change, validation commands, and any next failure observed after the fix.
