...
GRAPHEME_CASES = [
    ...
    "RegionalIndicator", "Prepend", "SpacingMark", "L", "V", "T", "LV", "LVT",
]
GRAPHEME_NAMES = {
    "Regional_Indicator": "RegionalIndicator",
    **{name: name for name in GRAPHEME_CASES},
}
GENERAL_CATEGORIES = [
...
COMPACT_LOOKUP_SOURCE = [
    ...
    "    if value == 1 then Unicode.Data.IndicConjunctBreak.Consonant",
    "    else if value == 2 then Unicode.Data.IndicConjunctBreak.InCBExtend",
    "    else if value == 3 then Unicode.Data.IndicConjunctBreak.Linker",
...
def generate_compact_data(
    ...
    lines = [
        ...
        "type IndicConjunctBreak = InCBNone | Consonant | InCBExtend | Linker",
